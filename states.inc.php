...
$machinestates = [
  ...
  ST_PLACE_STRUCTURE => [
    ...
    'descriptionconstraints' => clienttranslate('${actplayer} must place a structure (${structure}) in ${location}'),
    'descriptionmyturnconstraints' => clienttranslate('${you} must place a structure (${structure}) in ${location}'),
    'args' => 'argsAtomicAction',
    'action' => 'stAtomicAction',
    'type' => 'activeplayer',
  ...
  ST_SPECIAL_EFFECT => [
    ...
    'args' => 'argsAtomicAction',
    'type' => 'activeplayer',
    'possibleactions' => ['actPassOptionalAction', 'actRestart', 'actCopyPower', 'actUseBuilding'],
  ],
